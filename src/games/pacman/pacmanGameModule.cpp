...
void PacmanGameModule::init(ICore *coreHandle)
{
    ...
    this->textureBlinkyFaceRight1 = this->coreHandle->loadTexture("assets/pacman/blinky-face-right-1.png", 'R', ICore::Color::red, ICore::Color::none, 16, 16);
    this->texturePinkyFaceRight1 = this->coreHandle->loadTexture("assets/pacman/pinky-face-right-1.png", 'R', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->textureInkyFaceRight1 = this->coreHandle->loadTexture("assets/pacman/inky-face-right-1.png", 'R', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureClydeFaceRight1 = this->coreHandle->loadTexture("assets/pacman/clyde-face-right-1.png", 'R', ICore::Color::yellow, ICore::Color::none, 16, 16);
    ...
    this->textureMazeBoxBottomLeft = this->coreHandle->loadTexture("assets/pacman/maze-box-bottom-left.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxBottom = this->coreHandle->loadTexture("assets/pacman/maze-box-bottom.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxBottomRight = this->coreHandle->loadTexture("assets/pacman/maze-box-bottom-right.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxLeft = this->coreHandle->loadTexture("assets/pacman/maze-box-left.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxRight = this->coreHandle->loadTexture("assets/pacman/maze-box-right.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxTopLeft = this->coreHandle->loadTexture("assets/pacman/maze-box-top-left.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxTop = this->coreHandle->loadTexture("assets/pacman/maze-box-top.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxTopRight = this->coreHandle->loadTexture("assets/pacman/maze-box-top-right.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeLeft = this->coreHandle->loadTexture("assets/pacman/maze-left.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeRight = this->coreHandle->loadTexture("assets/pacman/maze-right.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeTopLeft = this->coreHandle->loadTexture("assets/pacman/maze-top-left.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeTopMiddleLeft = this->coreHandle->loadTexture("assets/pacman/maze-top-middle-left.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeTopMiddleRight = this->coreHandle->loadTexture("assets/pacman/maze-top-middle-right.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeTop = this->coreHandle->loadTexture("assets/pacman/maze-top.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeTopRight = this->coreHandle->loadTexture("assets/pacman/maze-top-right.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxBottomToLeftCorner = this->coreHandle->loadTexture("assets/pacman/maze-box-bottom-to-left-corner.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxBottomToRightCorner = this->coreHandle->loadTexture("assets/pacman/maze-box-bottom-to-right-corner.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxTopLeft = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-top-left.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxTop = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-top.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxEntranceLeft = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-entrance-left.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxEntranceRight = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-entrance-right.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxEntranceMiddle = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-entrance-middle.png", '-', ICore::Color::yellow, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxTopRight = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-top-right.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxLeft = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-left.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxRight = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-right.png", '|', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxBottom = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-bottom.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxBottomLeft = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-bottom-left.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeMiddleBoxBottomRight = this->coreHandle->loadTexture("assets/pacman/maze-middle-box-bottom-right.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBottom = this->coreHandle->loadTexture("assets/pacman/maze-bottom.png", '-', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeRightMiddleTop = this->coreHandle->loadTexture("assets/pacman/maze-right-middle-top.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeRightMiddleBottom = this->coreHandle->loadTexture("assets/pacman/maze-right-middle-bottom.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeLeftMiddleTop = this->coreHandle->loadTexture("assets/pacman/maze-left-middle-top.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeLeftMiddleBottom = this->coreHandle->loadTexture("assets/pacman/maze-left-middle-bottom.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxTopToLeftCorner = this->coreHandle->loadTexture("assets/pacman/maze-box-top-to-left-corner.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBoxTopToRightCorner = this->coreHandle->loadTexture("assets/pacman/maze-box-top-to-right-corner.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBottomLeft = this->coreHandle->loadTexture("assets/pacman/maze-bottom-left.png", '\\', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureMazeBottomRight = this->coreHandle->loadTexture("assets/pacman/maze-bottom-right.png", '/', ICore::Color::blue, ICore::Color::none, 8, 8);
    this->textureFruitApple = this->coreHandle->loadTexture("assets/pacman/fruit-apple.png", '-', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureFruitBell = this->coreHandle->loadTexture("assets/pacman/fruit-bell.png", '|', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureFruitCherries = this->coreHandle->loadTexture("assets/pacman/fruit-cherries.png", '_', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureFruitGalaxian = this->coreHandle->loadTexture("assets/pacman/fruit-galaxian.png", '^', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureFruitGrapes = this->coreHandle->loadTexture("assets/pacman/fruit-grapes.png", '/', ICore::Color::green, ICore::Color::none, 16, 16);
    this->textureFruitKey = this->coreHandle->loadTexture("assets/pacman/fruit-key.png", '|', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureFruitPeach = this->coreHandle->loadTexture("assets/pacman/fruit-peach.png", '-', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureFruitStrawberry = this->coreHandle->loadTexture("assets/pacman/fruit-strawberry.png", '-', ICore::Color::white, ICore::Color::none, 16, 16);
    this->texturePacmanFaceClosed = this->coreHandle->loadTexture("assets/pacman/pacman-face-closed.png", '-', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath1 = this->coreHandle->loadTexture("assets/pacman/pacman-death-1.png", 'v', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath2 = this->coreHandle->loadTexture("assets/pacman/pacman-death-2.png", 'v', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath3 = this->coreHandle->loadTexture("assets/pacman/pacman-death-3.png", '-', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath4 = this->coreHandle->loadTexture("assets/pacman/pacman-death-4.png", '-', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath5 = this->coreHandle->loadTexture("assets/pacman/pacman-death-5.png", '-', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath6 = this->coreHandle->loadTexture("assets/pacman/pacman-death-6.png", '_', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath7 = this->coreHandle->loadTexture("assets/pacman/pacman-death-7.png", '_', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath8 = this->coreHandle->loadTexture("assets/pacman/pacman-death-8.png", '|', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath9 = this->coreHandle->loadTexture("assets/pacman/pacman-death-9.png", '|', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath10 = this->coreHandle->loadTexture("assets/pacman/pacman-death-10.png", '|', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanDeath11 = this->coreHandle->loadTexture("assets/pacman/pacman-death-11.png", '*', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceDown1 = this->coreHandle->loadTexture("assets/pacman/pacman-face-down-1.png", '^', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceDown2 = this->coreHandle->loadTexture("assets/pacman/pacman-face-down-2.png", '^', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceLeft1 = this->coreHandle->loadTexture("assets/pacman/pacman-face-left-1.png", '>', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceLeft2 = this->coreHandle->loadTexture("assets/pacman/pacman-face-left-2.png", '>', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceRight1 = this->coreHandle->loadTexture("assets/pacman/pacman-face-right-1.png", '<', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceRight2 = this->coreHandle->loadTexture("assets/pacman/pacman-face-right-2.png", '<', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceUp1 = this->coreHandle->loadTexture("assets/pacman/pacman-face-up-1.png", 'v', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->texturePacmanFaceUp2 = this->coreHandle->loadTexture("assets/pacman/pacman-face-up-2.png", 'v', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureGhostEyesDown = this->coreHandle->loadTexture("assets/pacman/ghost-eyes-down.png", 'v', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostEyesLeft = this->coreHandle->loadTexture("assets/pacman/ghost-eyes-left.png", '<', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostEyesRight = this->coreHandle->loadTexture("assets/pacman/ghost-eyes-right.png", '>', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostEyesUp = this->coreHandle->loadTexture("assets/pacman/ghost-eyes-up.png", '^', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostFrightenedBlue1 = this->coreHandle->loadTexture("assets/pacman/ghost-frightened-blue-1.png", '-', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostFrightenedBlue2 = this->coreHandle->loadTexture("assets/pacman/ghost-frightened-blue-2.png", '-', ICore::Color::blue, ICore::Color::none, 16, 16);
    this->textureGhostFrightenedWhite1 = this->coreHandle->loadTexture("assets/pacman/ghost-frightened-white-1.png", '-', ICore::Color::white, ICore::Color::none, 16, 16);
    this->textureGhostFrightenedWhite2 = this->coreHandle->loadTexture("assets/pacman/ghost-frightened-white-2.png", '-', ICore::Color::white, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceRight2 = this->coreHandle->loadTexture("assets/pacman/blinky-face-right-2.png", 'R', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceDown1 = this->coreHandle->loadTexture("assets/pacman/blinky-face-down-1.png", 'D', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceDown2 = this->coreHandle->loadTexture("assets/pacman/blinky-face-down-2.png", 'D', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceLeft1 = this->coreHandle->loadTexture("assets/pacman/blinky-face-left-1.png", 'L', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceLeft2 = this->coreHandle->loadTexture("assets/pacman/blinky-face-left-2.png", 'L', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceUp1 = this->coreHandle->loadTexture("assets/pacman/blinky-face-up-1.png", 'U', ICore::Color::red, ICore::Color::none, 16, 16);
    this->textureBlinkyFaceUp2 = this->coreHandle->loadTexture("assets/pacman/blinky-face-up-2.png", 'U', ICore::Color::red, ICore::Color::none, 16, 16);
    this->texturePinkyFaceRight2 = this->coreHandle->loadTexture("assets/pacman/pinky-face-right-2.png", 'R', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceDown1 = this->coreHandle->loadTexture("assets/pacman/pinky-face-down-1.png", 'D', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceDown2 = this->coreHandle->loadTexture("assets/pacman/pinky-face-down-2.png", 'D', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceLeft1 = this->coreHandle->loadTexture("assets/pacman/pinky-face-left-1.png", 'L', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceLeft2 = this->coreHandle->loadTexture("assets/pacman/pinky-face-left-2.png", 'L', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceUp1 = this->coreHandle->loadTexture("assets/pacman/pinky-face-up-1.png", 'U', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->texturePinkyFaceUp2 = this->coreHandle->loadTexture("assets/pacman/pinky-face-up-2.png", 'U', ICore::Color::magenta, ICore::Color::none, 16, 16);
    this->textureInkyFaceRight2 = this->coreHandle->loadTexture("assets/pacman/inky-face-right-2.png", 'R', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceDown1 = this->coreHandle->loadTexture("assets/pacman/inky-face-down-1.png", 'D', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceDown2 = this->coreHandle->loadTexture("assets/pacman/inky-face-down-2.png", 'D', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceLeft1 = this->coreHandle->loadTexture("assets/pacman/inky-face-left-1.png", 'L', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceLeft2 = this->coreHandle->loadTexture("assets/pacman/inky-face-left-2.png", 'L', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceUp1 = this->coreHandle->loadTexture("assets/pacman/inky-face-up-1.png", 'U', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureInkyFaceUp2 = this->coreHandle->loadTexture("assets/pacman/inky-face-up-2.png", 'U', ICore::Color::cyan, ICore::Color::none, 16, 16);
    this->textureClydeFaceRight2 = this->coreHandle->loadTexture("assets/pacman/clyde-face-right-2.png", 'R', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceDown1 = this->coreHandle->loadTexture("assets/pacman/clyde-face-down-1.png", 'D', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceDown2 = this->coreHandle->loadTexture("assets/pacman/clyde-face-down-2.png", 'D', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceLeft1 = this->coreHandle->loadTexture("assets/pacman/clyde-face-left-1.png", 'L', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceLeft2 = this->coreHandle->loadTexture("assets/pacman/clyde-face-left-2.png", 'L', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceUp1 = this->coreHandle->loadTexture("assets/pacman/clyde-face-up-1.png", 'U', ICore::Color::yellow, ICore::Color::none, 16, 16);
    this->textureClydeFaceUp2 = this->coreHandle->loadTexture("assets/pacman/clyde-face-up-2.png", 'U', ICore::Color::yellow, ICore::Color::none, 16, 16);
